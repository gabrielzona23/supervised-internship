...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'electrical_installation_core'  => 'código da instalação elétrica',
        'residential_area'              => 'área residencial',
        'type_transport'                => 'tipo de transporte',
        'reference'                     => 'ponto de referência',
        'complement'                    => 'complemento do endereço',
        'buses_name'                    => 'nome do ônibus',
        'transport_localization'        => 'localidade transporte',
        'route'                         => 'rota',
        'nickname'                      => 'nome de usuário',
        'born_date'                     => 'data de nascimento',
        'born_state'                    => 'estado de nascimento',
        'emitter_rg'                    => 'órgão emissor',
        'nationality'                   => 'nacionalidade',
        'born_city'                     => 'naturalidade',
        'number_card_sus'               => 'número do cartão do sus',
        'inep_code'                     => 'código inep',
        'job'                           => 'profissão',
        'programs'                      => 'programas',
        'has_special_needs'             => 'possui necessidades especiais',
        'special_educational_needs'     => 'necessidades especiais',
        'color'                         => 'cor',
        'breed'                         => 'raça',
        'gender'                        => 'gênero',
        'image_authorization'           => 'autorização do uso de imagem',
        'g_mus'                         => 'código g-mus',
        'school_year'                   => 'ano letivo',
        'document_model'                => 'modelo de documento',
        'document_number'               => 'número do documento',
        'name_registry'                 => 'nome do cartório',
        'type_of_certificate'           => 'tipo de certidão',
        'city_registry'                 => 'município do cartório',
        'state_registry'                => 'estado do cartório',
        'term_number'                   => 'número do termo',
        'sheet_number'                  => 'número da folha',
        'book_number'                   => 'número do livro',
        'emission_date'                 => 'data de emissão',
        'name1'                         => 'nome do responsável',
        'kinship'                       => 'grau de parentesco',
        'cpf1'                          => 'cpf do responsável',
        'rg1'                           => 'rg do responsável',
        'emitter_rg1'                   => 'órgão emissor do rg do responsável',
        'family_bag'                    => 'bolsa família',
        'nis1'                          => 'nis do responsável',
        'parents_divorced'              => 'pais divorciados',
        'student_custody'               => 'guarda do estudante',
        'guard_document'                => 'documentos da guarda',
        ''
    ],
