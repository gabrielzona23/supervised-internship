...
<div class="col-md-12">
    <div class="card text-left">
        <form method="post" action="{{ route('anamneses.update', $student) }}" class="needs-validation"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <select class="form-control form-control-rounded" name="{{ $question->id }}"
                                        id="{{ $question->id }}">
                                        <option value="" selected disabled>----Selecione----</option>
                                        <option value=0>Para se socializar</option>
                                        <option value=1>Para a mãe trabalhar fora</option>
