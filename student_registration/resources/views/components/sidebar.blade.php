    ...
    <div class="side-content-wrap">
        <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
            <ul class="navigation-left">
                <li class="nav-item" data-item=""><a class="nav-item-hold" href="{{route('students.create')}}"><i class="nav-icon i-File-Clipboard-File--Text"></i><span class="nav-text">Cadastro de Alunos</span></a>
